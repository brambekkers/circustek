	...
	<div class="landing">
		...
		<section class="bottom">
			<small id="disclaimer">
				...
				nieuwe website is in ontwikkeling.<br />
			...
			<h6>CIRCUSTEK</h6>
			<p>
				Ophalen gereserveerd materiaal: <br />
				Maandag 10:30 tot 14:30 uur<br />
				Dinsdag 13:30 tot 16:00 uur<br />
				Donderdag 8:30 tot 14:30 uur<br />
				Vrijdag 10:30 tot 14:30 uur<br />
			</p>
			<h6>OPLEIDINGEN</h6>
			<p>
			...
			<p class="mb-5">
				Meer info: <A HREF="mailto:j.vanveen@hmcollege.nl">Jacinta van Veen</A>
			</p>
		</section>
	</div>
</template>
		...
		.content {
			...
			.separator {
				...
				.line_left:before {
					...
					width: 41%;
					height: 1px;
					background-image: linear-gradient(to left, rgb(48, 49, 51), transparent);
				}
